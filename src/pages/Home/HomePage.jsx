...
export default function HomePage() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      setOffset(window.scrollY * 0.5); // Adjust speed (0.5 means slower scroll)
    };
  ...
  return (
    <>
      <section className="relative w-full h-[150vh] md:h-[115vh]  overflow-hidden">
        {/* Parallax Image */}
        <div
          ...
          style={{
            ...
            transform: `translateY(${offset}px)`, // Moves slower
          }}
        ></div>
        ...
        {/* Centered Text */}
        <div className="absolute inset-0 flex flex-col items-center md:justify-center text-white">
          <div className="flex flex-col items-center gap-y-5 mb-10 -space-y-3 mt-40 md:mt-0">
